...
void initialDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        initialDialog *_t = static_cast<initialDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (initialDialog::*_t)() const;
...
const QMetaObject initialDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_initialDialog.data,
      qt_meta_data_initialDialog,  qt_static_metacall, nullptr, nullptr}
};
