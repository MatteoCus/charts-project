...
void chartViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<chartViewer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (chartViewer::*)() const;
...
QT_INIT_METAOBJECT const QMetaObject chartViewer::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_chartViewer.data,
    qt_meta_data_chartViewer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
